...
const defaultColorsArray = Object.values(defaultColors)
  ...
  return (
    <div className="sketchpad-container">
      <div className="sketchpad-header">
        <h2>Sketchpad</h2>
        <div className="sketchpad-stats">
          <span>{points.length} strokes</span>
        </div>
      </div>
          ...
          <div className="tools-section">
            <div className="tools-grid">
              {tools.map(option => (
                <button
                  key={option.tool}
                  onClick={() => setTool(option.tool as Tool)}
                  className={`tool-button ${tool === option.tool ? 'active' : ''}`}
                  title={option.label}
                >
          ...
          <div className="color-section">
            <div className="color-picker">
              ...
              <div className="color-grid">
                {defaultColorsArray.map(colorOption => (
                  <button
                    key={colorOption}
